...
class RepeaterManager:
    ...
    async def track_contact_advertisement(self, advert_data: Dict, signal_info: Dict = None, packet_hash: Optional[str] = None) -> bool:
        ...
        try:
            ...
            existing = await self.db_manager.aexecute_query(
            ...
            if existing:
                ...
                await self.db_manager.aexecute_update('''
    ...
    async def _track_daily_advertisement(self, public_key: str, name: str, role: str, device_type: str,
        ...
        try:
            ...
            existing_daily = await self.db_manager.aexecute_query(
        ...
        try:
            if include_historical:
                if role_filter:
                    ...
                    '''
                    results = await self.db_manager.aexecute_query(query, (role_filter,))
                else:
                    ...
                    query = '''
                        ...
                        ORDER BY last_heard DESC
                    '''
                    results = await self.db_manager.aexecute_query(query)
            else:
                if role_filter:
    ...
    async def get_contact_statistics(self) -> Dict:
        ...
        try:
            ...
            total_result = await self.db_manager.aexecute_query(
            ...
            current_result = await self.db_manager.aexecute_query(
            ...
            recent_result = await self.db_manager.aexecute_query(
            ...
            # Role breakdown
            role_result = await self.db_manager.aexecute_query(
            ...
            type_result = await self.db_manager.aexecute_query(
        ...
        try:
            ...
            for contact_key, contact_data in self.bot.meshcore.contacts.items():
                ...
                tracking_query = '''
                    ...
                    LIMIT 1
                '''
                tracking_data = await self.db_manager.aexecute_query(tracking_query, (public_key,))
                ...
                if name:
                    ...
                    '''
                    dm_results = await self.db_manager.aexecute_query(dm_query, (name,))
            ...
            for contact_key, contact_data in self.bot.meshcore.contacts.items():
                ...
                if self._is_repeater_device(contact_data):
                    ...
                    if existing:
                        ...
                        await self.db_manager.aexecute_update(update_query, tuple(update_params))
                        updated_count += 1
                    else:
    ...
    async def get_repeater_contacts(self, active_only: bool = True) -> List[Dict]:
        ...
        try:
            ...
            return await self.db_manager.aexecute_query(query)
    ...
    async def purge_repeater_from_contacts(self, public_key: str, reason: str = "Manual purge") -> bool:
        ...
        try:
            ...
            existing_repeater = await self.db_manager.aexecute_query(
    ...
    async def purge_old_repeaters(self, days_old: int = 30, reason: str = "Automatic purge - old contacts") -> int:
        ...
        try:
            ...
            all_repeaters = await self.db_manager.aexecute_query('''
    ...
    async def restore_repeater(self, public_key: str, reason: str = "Manual restore") -> bool:
        ...
        try:
            ...
            result = await self.db_manager.aexecute_query('''
    ...
    async def get_purging_stats(self) -> Dict:
        ...
        try:
            # Get total counts
            total_repeaters = (await self.db_manager.aexecute_query('SELECT COUNT(*) as count FROM repeater_contacts'))[0]['count']
            active_repeaters = (await self.db_manager.aexecute_query('SELECT COUNT(*) as count FROM repeater_contacts WHERE is_active = 1'))[0]['count']
            purged_repeaters = (await self.db_manager.aexecute_query('SELECT COUNT(*) as count FROM repeater_contacts WHERE is_active = 0'))[0]['count']

            # Get recent purging activity
            recent_activity = await self.db_manager.aexecute_query('''
    ...
    async def cleanup_database(self, days_to_keep_logs: int = 90):
        ...
        try:
            ...
            deleted_count = await self.db_manager.aexecute_update(
    ...
    async def populate_missing_geolocation_data(self, dry_run: bool = False, batch_size: int = 10) -> Dict[str, int]:
        ...
        try:
            ...
            repeaters_to_update = await self.db_manager.aexecute_query('''
                ...
                try:
                    ...
                    if updates:
                        if not dry_run:
                            ...
                            await self.db_manager.aexecute_update(update_query, tuple(params))
    ...
    async def _background_geocoding(self):
        ...
        try:
            ...
            contacts_needing_geocoding = await self.db_manager.aexecute_query('''
                SELECT id, name, latitude, longitude, city, state, country
                FROM complete_contact_tracking
                WHERE latitude IS NOT NULL
                AND longitude IS NOT NULL
            ...
            try:
                ...
                if updates:
                    ...
                    await self.db_manager.aexecute_update(query, params)
